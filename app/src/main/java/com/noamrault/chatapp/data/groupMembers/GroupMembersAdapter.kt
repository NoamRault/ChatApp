package com.noamrault.chatapp.data.groupMembers
...
import com.noamrault.chatapp.ui.main.RemoveMemberDialogFragment

class GroupMembersAdapter(
    private val dataSet: ArrayList<Friend>,
    ...
    override fun onBindViewHolder(viewHolder: ViewHolder, position: Int) {
        ...
        viewHolder.button.setOnClickListener {
            RemoveMemberDialogFragment(viewHolder.view.findFragment(), groupId, id, username)
                .show(
